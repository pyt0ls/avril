...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`**\`💬\`** • Olá ${interaction.user.username}! Como sabe, sou o kn0w, um simples bot contendo diversos comandos para divertir e ajudar você ou seu servidor!\n\n**• Veja algumas informações.**`)
      .addFields(
        {
          name: '[🏆] • avril:',
          value: `> **• Nome:** ${bot.username}\n> **• Prefixo:** ${config.PREFIX} (padrão)\n> **• Comandos:** ${interaction.client.commands.size} no total.`
        },
        {
          name: '[👑] • Developer:',
